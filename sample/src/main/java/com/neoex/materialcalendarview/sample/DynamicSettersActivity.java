...
import com.neoex.materialcalendarview.CalendarMode;
...
public class DynamicSettersActivity extends AppCompatActivity implements OnDateLongClickListener {
  ...
  void onTextAppearanceChecked(boolean checked) {
    if (checked) {
      widget.setHeaderTextAppearance(androidx.appcompat.R.style.TextAppearance_AppCompat_Large);
      widget.setDateTextAppearance(androidx.appcompat.R.style.TextAppearance_AppCompat_Medium);
      widget.setWeekDayTextAppearance(androidx.appcompat.R.style.TextAppearance_AppCompat_Medium);
    } else {
      widget.setHeaderTextAppearance(com.neoex.materialcalendarview.R.style.TextAppearance_MaterialCalendarWidget_Header);
      widget.setDateTextAppearance(com.neoex.materialcalendarview.R.style.TextAppearance_MaterialCalendarWidget_Date);
      widget.setWeekDayTextAppearance(com.neoex.materialcalendarview.R.style.TextAppearance_MaterialCalendarWidget_WeekDay);
    }
