...
public class DynamicSettersActivity extends AppCompatActivity implements OnDateLongClickListener {
  ...
  void onTextAppearanceChecked(boolean checked) {
    if (checked) {
      ...
      widget.setHeaderTextAppearance(you.thiago.materialcalendarview.R.style.TextAppearance_MaterialCalendarWidget_Header);
      widget.setDateTextAppearance(you.thiago.materialcalendarview.R.style.TextAppearance_MaterialCalendarWidget_Date);
      widget.setWeekDayTextAppearance(you.thiago.materialcalendarview.R.style.TextAppearance_MaterialCalendarWidget_WeekDay);
    }
